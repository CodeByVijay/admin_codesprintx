...
@section('content')
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Edit Program', 'url' => '#'],
    ]" title="Edit Program" backUrl="{{ route('courses.index') }}" />
                ...
                <div class="card-body">
                    <form action="{{ route('courses.update', $course->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="programDescription">Program Description(Short) <span
                                    ...
                                    <input type="text" class="form-control" name="short_desc" id="programDescription"
                                        ...
                                        required value="{{ old('short_desc', $course->short_desc) }}">
                                    @error('short_desc')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="programSkills">Program Skills (comma separated) <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="skills" id="programSkills"
                                        ...
                                        value="{{ old('skills', (is_array($course->skills) ? implode(',', $course->skills) : (is_string($course->skills) && str_starts_with($course->skills, '[') ? implode(',', json_decode($course->skills, true)) : $course->skills))) }}">
                                    @error('skills')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-colorpicker2">
                                        <input type="text" name="bg_color" class="form-control"
                                            placeholder="Card Background Color" required
                                            value="{{ old('bg_color', $course->bg_color) }}">
                                        @error('bg_color')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="programDescription">Program Description(Long) <span
                                            class="text-danger">*</span></label>
                                    <textarea id="summernote" name="long_desc" placeholder="Write Long Description">{{ old('long_desc', $course->long_desc) }}</textarea>
                                    @error('long_desc')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12 card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="original_price_3_month">3 Month Normal Price <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="original_price_3_month"
                                                    ...
                                                    required
                                                    value="{{ old('original_price_3_month', $course->original_price_3_month) }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="original_price_6_month">6 Month Normal Price <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="original_price_6_month"
                                                    ...
                                                    required
                                                    value="{{ old('original_price_6_month', $course->original_price_6_month) }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="offer_end_at">Offer End Date </label>
                                                <div class="input-group date" id="reservationdatetime"
                                                    ...
                                                    <input type="text" name="offer_end_at" id="offer_end_at"
                                                        ...
                                                        value="{{ old('offer_end_at', $course->offer_end_at) }}" />
                                                    @error('offer_end_at')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                            ...
                            <div class="col-md-12 card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="meta_keywords">Meta Keywords(comma separated) <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="meta_keywords"
                                                    id="meta_keywords"
                                                    placeholder="Enter Meta Keywords comma separated e.g. HTML,CSS,JS"
                                                    required value="{{ old('meta_keywords', $course->meta_keywords) }}">
                                                @error('meta_keywords')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div id="projects-section" class="col-12">
                                            @php
                                                $projects = old(
                                                    'projects',
                                                    is_array($course->projects)
                                                        ? $course->projects
                                                        : (is_string($course->projects)
                                                            ? json_decode($course->projects, true)
                                                            : []),
                                                );
                                            @endphp
                                            @if (empty($projects))
                                                @php $projects = [['name' => '', 'description' => '']]; @endphp
                                            @endif
                                            @foreach ($projects as $i => $project)
                                                <div class="form-row align-items-center mb-2 project-row">
                                                    <div class="col-md-5">
                                                        <input type="text" name="projects[{{ $i }}][name]" class="form-control" placeholder="Project Name" required value="{{ old('projects.' . $i . '.name', $project['name'] ?? '') }}">
                                                        @error('projects.' . $i . '.name')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="text" name="projects[{{ $i }}][description]" class="form-control" placeholder="Project Description" required value="{{ old('projects.' . $i . '.description', $project['description'] ?? '') }}">
                                                        @error('projects.' . $i . '.description')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-1">
                                                        @if ($i == 0)
                                                            <button type="button" class="btn btn-success add-project"><i class="fa fa-plus"></i></button>
                                                        @else
                                        ...
                                        <div id="what-you-learn-section" class="col-12">
                                            @php
                                                $whatYouLearn = old(
                                                    ...
                                                    is_array($course->what_you_learn)
                                                        ...
                                                        : (is_string($course->what_you_learn) && str_starts_with($course->what_you_learn, '[')
                                                            ? json_decode($course->what_you_learn, true)
                                                            : []),
                                                );
                                            @endphp
                                            ...
                                            @foreach ($whatYouLearn as $i => $item)
                                                <div class="form-row align-items-center mb-2 what-you-learn-row">
                                                    <div class="col-md-11">
                                                        <input type="text" name="what_you_learn[{{ $i }}]" class="form-control" placeholder="What will you learn?" required value="{{ old('what_you_learn.' . $i, $item) }}">
                                                    ...
                                                    <div class="col-md-1">
                                                        @if ($i == 0)
                                                            <button type="button" class="btn btn-success add-what-you-learn"><i class="fa fa-plus"></i></button>
                                                        @else
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.remove-what-you-learn', function() {
                if ($('.what-you-learn-row').length > 1) {
                    ...
                    $('.what-you-learn-row').each(function(idx, row) {
                        $(row).find('input[name^="what_you_learn"]').attr('name', `what_you_learn[${idx}]`);
                    });
                    learnIndex = $('.what-you-learn-row').length;
                }
            });
            // Set projectIndex to the current number of project rows
            let projectIndex = $('.project-row').length;
            ...
            $(document).on('click', '.remove-project', function() {
                if ($('.project-row').length > 1) {
                    ...
                    // Re-index all project rows' input names
                    $('.project-row').each(function(idx, row) {
                        $(row).find('input[name^="projects"]').each(function() {
                            const field = $(this).attr('name').split('][')[1].replace(']', '');
                            $(this).attr('name', `projects[${idx}][${field}]`);
                        });
                    });
                    projectIndex = $('.project-row').length;
                }
            });
        });
        ...
        $(document).ready(function() {
            ...
            function showPreview(icon) {
                if (icon && iconList.includes(icon)) {
                    ...
                    $inputPreview.html(`<i class="${icon} text-muted"></i>`);
                } else {
                    $inputPreview.html('<i class="fa fa-question text-muted"></i>');
                }
            }

            // Set initial preview to current value
            ...
            $input.on('input', function() {
                ...
                const matches = iconList.filter(icon => icon.toLowerCase().includes(val.toLowerCase())).slice(0, 300);
                if (matches.length) {
            ...
            const colorVal = $('input[name="bg_color"]').val();
            if (colorVal) {
                $('.my-colorpicker2 .fa-square').css('color', colorVal);
            }
