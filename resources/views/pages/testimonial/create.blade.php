...
@section('content')
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'New Testimonial', 'url' => '#'],
    ]" title="Add New Testimonial" backUrl="{{ route('testimonials.index') }}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="rating" id="rating" required>
                                        ...
                                        <option value="1" {{ old('rating') == '1' ? 'selected' : '' }}>1 Star (Very Poor)</option>
                                    </select>
                                    @error('rating')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="message" id="message" rows="5"
                                        placeholder="Enter testimonial message" minlength="10" maxlength="1000" required>{{ old('message') }}</textarea>
                                    @error('message')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div id="imagePreview" style="display: none;">
                                    <img id="preview" src="#" alt="Preview" class="img-thumbnail mt-2" style="max-width: 150px; max-height: 150px;">
                                </div>
                            </div>
